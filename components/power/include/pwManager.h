...
#define OUTPUT2_PIN 14
#define INPUT1_PIN 11  // GPIO11
#define INPUT2_PIN 12  // GPIO12
/** revisar todas estas funciones publicas si es necesario que esté declarado como publicas */
void power_init();
